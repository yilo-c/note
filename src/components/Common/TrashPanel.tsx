  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative w-[420px] max-w-[90vw] max-h-[70vh] flex flex-col rounded-2xl shadow-2xl overflow-hidden border"
        style={{
      ...
      >
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-[9px]" style={{ color: 'var(--text-muted)' }}>
                      {item.type === 'todo' ? '待办' : '便签'} · {formatTime(item.deletedAt)}
                    </div>
                  </div>
        ...
        {items.length > 0 && (
          <div className="flex items-center justify-end px-4 py-2.5 border-t" style={{ borderColor: 'var(--separator)' }}>
            {confirmClear ? (
              <div className="flex items-center gap-2">
                <span className="text-[10px]" style={{ color: 'var(--text-muted)' }}>确认清空回收站？</span>
